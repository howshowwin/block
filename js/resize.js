...
function convertSizeALL(className) {
    ...
    $('.img_thd').css({ width: Math.round(125 * 0.8 * sRatio), height: Math.round(115 * 0.8 * sRatio) });
    $('.img_hun').css({ width: Math.round(164 * 0.8 * sRatio), height: Math.round(53 * 0.8 * sRatio) });
    $('.img_ten').css({ width: Math.round(19 * 0.8 * sRatio), height: Math.round(129 * 0.8 * sRatio) });
